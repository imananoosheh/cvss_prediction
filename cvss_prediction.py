...
class NLPModelCNN(NLPModel):
	...
	def build_cnn_model(self):
		...
		train_encoding_padded = tf.keras.preprocessing.sequence.pad_sequences(train_encoding, maxlen = max_len, padding = "post")
		test_encoding_paded = tf.keras.preprocessing.sequence.pad_sequences(test_encoding, maxlen = max_len, padding = "post")
